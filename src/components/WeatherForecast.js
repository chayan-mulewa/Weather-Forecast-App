...
function WeatherForecast() {
    ...
    function getWeatherDataIcons(iconCode) {
                ...
                <div className="flex flex-col gap-4">
                    ...
                    <div className="flex flex-col md:flex-row gap-4">
                        <div className="flex-grow bg-black rounded-lg p-4">
                            ...
                            <h1 className="text-white mb-4">Temp : {finalTemp}</h1>
                            <h1 className="flex flex-row    place-items-center text-white">Weather Type : <img src={getWeatherDataIcons(icon)}></img> {type}</h1>
                    ...
                    <div className="flex flex-col place-content-between  bg-slate-200 text-black rounded-lg gap-4 p-4  md:flex-row gap-4">
                        <div className="flex flex-col">
                            <h1 className='flex flex-row place-content-start place-items-center' >Sunrise <img src='https://openweathermap.org/img/wn/01d.png'></img></h1>
                            <h1>{sunrise}</h1>
                        </div>
                        <div className="flex flex-col">
                        <h1 className='flex flex-row place-content-start place-items-center' >Sunset <img src='https://openweathermap.org/img/wn/02d.png'></img></h1>
                            <h1>{sunset}</h1>
                        </div>
                        <div className="flex flex-col">
                        <h1 className='flex flex-row place-content-start place-items-center' >Humidity <img src='https://openweathermap.org/img/wn/13d.png'></img></h1>
                            <h1>{humidity}</h1>
                        </div>
                        <div className="flex flex-col">
                        <h1 className='flex flex-row place-content-start place-items-center gap-2' >Pressure <img  src='https://openweathermap.org/img/wn/01n.png'></img></h1>
                            <h1>{pressure}</h1>
                        </div>
                        <div className="flex flex-col">
                        <h1 className='flex flex-row place-content-start place-items-center' >Wind <img src='https://openweathermap.org/img/wn/50d.png'></img></h1>
                            <h1>{wind}</h1>
                        </div>
                    </div>
